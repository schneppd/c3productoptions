                                                    ...
                                                    <div class="attribute_list">
                                                        ...
                                                        {elseif ($group.group_type == 'radio')}
                                                            <ul>
                                                                {foreach from=$group.attributes key=id_attribute item=group_attribute}
                                                                    <li>
                                                                        <input type="radio" class="attribute_radio" id="{$groupName|escape:'html':'UTF-8'}" name="{$groupName|escape:'html':'UTF-8'}" value="{$id_attribute}" {if ($group.default == $id_attribute)} checked="checked"{/if} />
                                                                        <span>{$group_attribute|escape:'html':'UTF-8'}</span>
                                                                    </li>
                                                                {/foreach}
                                                            </ul>
                                                        {elseif ($group.group_type == 'text')}
                                                            <div>
                                                                {foreach from=$group.attributes key=id_attribute item=group_attribute}
                                                                        <input type="text" class="attribute_text" id="{$groupName|escape:'html':'UTF-8'}" name="{$groupName|escape:'html':'UTF-8'}" value="" data-id-attribute="{$id_attribute}"/>
                                                                {/foreach}
                                                            </div>
                                                        {elseif ($group.group_type == 'checkbox')}
                                                            <div>
                                                                {foreach from=$group.attributes key=id_attribute item=group_attribute}
                                                                        <input type="checkbox" class="attribute_checkbox{if ($group.group_required == true)} required{/if}" id="{$groupName|escape:'html':'UTF-8'}" name="{$groupName|escape:'html':'UTF-8'}" value="{$id_attribute}" {if ($group.default == $id_attribute)} checked="checked"{/if} />
                                                                {/foreach}
                                                            </div>
                                                        {/if}
